        ...
        private void buttonSearch_Click(object sender, EventArgs e)
        {
            ...
            */
            try
            {
               ...
               if (checkBoxWords.Checked && checkBoxExeptionWords.Checked && checkBoxAutor.Checked)
                {
                    if (rbAndKW.Checked && rbAndExKW.Checked)
                        dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, " AND ", " AND ", dcont.GetCommand(res), false, false, textBoxAutor.Text);
                    else if (rbAndKW.Checked && rbOrExKW.Checked)
                        dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, " AND ", " OR ", dcont.GetCommand(res), false, false, textBoxAutor.Text);
                    else if (rbAndKW.Checked && rbComboExKW.Checked)
                        dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, " AND ", String.Empty, dcont.GetCommand(res), false, true, textBoxAutor.Text);
                    else if (rbOrKW.Checked && rbAndExKW.Checked)
                        dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, " OR ", " AND ", dcont.GetCommand(res), false, false, textBoxAutor.Text);
                    else if (rbOrKW.Checked && rbOrExKW.Checked)
                        dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, " OR ", " OR ", dcont.GetCommand(res), false, false, textBoxAutor.Text);
                    else if (rbOrKW.Checked && rbComboExKW.Checked)
                        dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, " OR ", String.Empty, dcont.GetCommand(res), false, true, textBoxAutor.Text);
                    else if (rbComboKW.Checked && rbAndExKW.Checked)
                        dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, String.Empty, " AND ", dcont.GetCommand(res), true, false, textBoxAutor.Text);
                    else if (rbComboKW.Checked && rbOrExKW.Checked)
                        dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, String.Empty, " OR ", dcont.GetCommand(res), true, false, textBoxAutor.Text);
                    else if (rbComboKW.Checked && rbComboExKW.Checked)
                        dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, String.Empty, String.Empty, dcont.GetCommand(res), true, true, textBoxAutor.Text);
               ...
               {
                   if (rbAndKW.Checked && rbAndExKW.Checked)
                       dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, " AND ", " AND ", dcont.GetCommand(res), false, false, string.Empty);
                   else if (rbAndKW.Checked && rbOrExKW.Checked)
                       dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, " AND ", " OR ", dcont.GetCommand(res), false, false, string.Empty);
                   else if (rbAndKW.Checked && rbComboExKW.Checked)
                       dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, " AND ", String.Empty, dcont.GetCommand(res), false, true, string.Empty);
                   else if (rbOrKW.Checked && rbAndExKW.Checked)
                       dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, " OR ", " AND ", dcont.GetCommand(res), false, false, string.Empty);
                   else if (rbOrKW.Checked && rbOrExKW.Checked)
                       dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, " OR ", " OR ", dcont.GetCommand(res), false, false, string.Empty);
                   else if (rbOrKW.Checked && rbComboExKW.Checked)
                       dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, " OR ", String.Empty, dcont.GetCommand(res), false, true, string.Empty);
                   else if (rbComboKW.Checked && rbAndExKW.Checked)
                       dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, String.Empty, " AND ", dcont.GetCommand(res), true, false, string.Empty);
                   else if (rbComboKW.Checked && rbOrExKW.Checked)
                       dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, String.Empty, " OR ", dcont.GetCommand(res), true, false, string.Empty);
                   else if (rbComboKW.Checked && rbComboExKW.Checked)
                       dGridView.DataSource = Util.MultiQueryResult(textBoxKeyWords.Text, textBoxExeptionWords.Text, String.Empty, String.Empty, dcont.GetCommand(res), true, true, string.Empty);
                ...
                else if (checkBoxWords.Checked && checkBoxAutor.Checked)
                {
                    ...
                    {
                        dGridView.DataSource = Util.ComboQueryResult(textBoxKeyWords.Text, String.Empty, dcont.GetCommand(res), true, false, textBoxAutor.Text);
                    }
                    else if (rbAndKW.Checked)
                    {
                        dGridView.DataSource = Util.ComboQueryResult(textBoxKeyWords.Text, " AND ", dcont.GetCommand(res), false, false, textBoxAutor.Text);
                    }
                    else if (rbOrKW.Checked)
                    {
                        dGridView.DataSource = Util.ComboQueryResult(textBoxKeyWords.Text, " OR ", dcont.GetCommand(res), false, false, textBoxAutor.Text);
                    }
                }
                else if (checkBoxExeptionWords.Checked && checkBoxAutor.Checked)
                {
                    ...
                    {
                        dGridView.DataSource = Util.ComboQueryResult(textBoxExeptionWords.Text, String.Empty, dcont.GetCommand(res), true, true, textBoxAutor.Text);
                    }
                    else if (rbAndExKW.Checked)
                    {
                        dGridView.DataSource = Util.ComboQueryResult(textBoxExeptionWords.Text, " AND ", dcont.GetCommand(res), false, true, textBoxAutor.Text);
                    }
                    else if (rbOrExKW.Checked)
                    {
                        dGridView.DataSource = Util.ComboQueryResult(textBoxExeptionWords.Text, " OR ", dcont.GetCommand(res), false, true, textBoxAutor.Text);
                    }
                }
                else if (checkBoxWords.Checked)
                    {
                        if (rbComboKW.Checked)
                        {
                            dGridView.DataSource = Util.ComboQueryResult(textBoxKeyWords.Text, String.Empty, dcont.GetCommand(res), true, false, string.Empty);
                        }
                        else if (rbAndKW.Checked)
                        {
                            dGridView.DataSource = Util.ComboQueryResult(textBoxKeyWords.Text, " AND ", dcont.GetCommand(res), false, false, string.Empty);
                        }
                        else if (rbOrKW.Checked)
                        {
                            dGridView.DataSource = Util.ComboQueryResult(textBoxKeyWords.Text, " OR ", dcont.GetCommand(res), false, false, string.Empty);
                        }
                    }
                 ...
                 else if (checkBoxExeptionWords.Checked)
                    {
                        if (rbComboExKW.Checked)
                        {
                            dGridView.DataSource = Util.ComboQueryResult(textBoxExeptionWords.Text, String.Empty, dcont.GetCommand(res), true, true, string.Empty);
                        }
                        else if (rbAndExKW.Checked)
                        {
                            dGridView.DataSource = Util.ComboQueryResult(textBoxExeptionWords.Text, " AND ", dcont.GetCommand(res), false, true, string.Empty);
                        }
                        else if (rbOrExKW.Checked)
                        {
                            dGridView.DataSource = Util.ComboQueryResult(textBoxExeptionWords.Text, " OR ", dcont.GetCommand(res), false, true, string.Empty);
                        }
                    }
